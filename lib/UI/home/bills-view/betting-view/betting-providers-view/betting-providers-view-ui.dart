...
class BettingProviderScreen extends StatelessWidget {
  final List<Bet9ja> providers;
  final Function(Bet9ja) selectBettingProvider;
  final Bet9ja? selectedProvider;
  const BettingProviderScreen({
    super.key,
    required this.providers,
    required this.selectBettingProvider,
              ...
              return Column(
                children: [
                  ListTile(
                    title: Row(
                      children: [
                        ...
                        Radio(
                          ...
                          onChanged: (value) {
                            selectBettingProvider(providers[index]);
                    ...
                    onTap: () async {
                      await selectBettingProvider(providers[index]);
                      navigationService.goBack();
                    },
                  ),
                  const Divider()
