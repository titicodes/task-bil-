...
class EducationProviderScreen extends StatelessWidget {
  final List<EducationData> providers;
  final Function(EducationData) selectEducartionProvider;
  final EducationData? selectedProvider;

  const EducationProviderScreen({
    super.key,
    required this.selectEducartionProvider,
                ...
                return Column(
                  children: [
                    ListTile(
                      title: Row(
                        children: [
                          ...
                          Radio(
                            ...
                            onChanged: (value) {
                              selectEducartionProvider(providers[index]);
                      ...
                      onTap: () async {
                        await selectEducartionProvider(providers[index]);
                        navigationService.goBack();
                      },
                    ),
                    const Divider()
