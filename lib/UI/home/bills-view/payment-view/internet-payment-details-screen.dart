...
import 'package:taskitly/UI/home/bills-view/payment-view/internet-payment-details-vm.dart';
...
class InternetPaymentDetailsScreen extends StatelessWidget {
  // modified something here remember if code brs
  final String? phoneNumber;
  final String amount;
  final String? selectedDataName;
  final Smile? selectedProvider;

  const InternetPaymentDetailsScreen(
      {super.key,
  ...
  Widget build(BuildContext context) {
    return OtherView<InternetPaymentDetailsViewModel>(
